 ...
 * pieces cost
 */
internal const val PIECE_COST = 10_000

/**
 * cost of additional moves (unnecessary) in winning positions
 */
internal const val DEPTH_COST = 1

/**
 * how much danger enemy unfinished triples are
 */
internal const val ENEMY_UNFINISHED_TRIPLES_COST = 3

/**
 * how much unfinished triple costs
 */
internal const val UNFINISHED_TRIPLES_COST = 200

/**
 * how much possible triple costs
 */
internal const val POSSIBLE_TRIPLE_COST = 5

/**
 * needed pieces to be able to fly over the board
 */
internal const val PIECES_TO_FLY: UByte = 3U
 ...
 */
internal const val WON_GAME_COST = 1_000_000_000
 ...
 * @see Position.evaluate
 */
internal const val LOST_GAME_COST = -1_000_000_000
